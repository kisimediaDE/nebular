...
function installMainPeerDependencies(tree: Tree) {
  ...
  addDependencyToPackageJson(tree, '@kisimedia/nebular-theme', nebularThemeVersion);
  addDependencyToPackageJson(tree, '@kisimedia/nebular-eva-icons', nebularThemeVersion);
