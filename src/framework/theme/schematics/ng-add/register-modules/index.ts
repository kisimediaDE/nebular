...
function registerNebularModules(options: Schema): Rule {
  return async (tree: Tree) => {
    ...
    addModuleImportToRootModule(tree, nebularThemeModule, '@kisimedia/nebular-theme', project);
    addModuleImportToRootModule(tree, 'NbLayoutModule', '@kisimedia/nebular-theme', project);
    addModuleImportToRootModule(tree, 'NbEvaIconsModule', '@kisimedia/nebular-eva-icons', project);
  };
}
